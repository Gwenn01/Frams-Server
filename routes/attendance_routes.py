...
def start_session():
    try:
        ...
        # =====================================================
        # 3. VALIDATE CURRENT TIME WITH CLASS SCHEDULE
        # =====================================================
        ...
        is_scheduled_now = any(
            current_day in blk.get("days", []) and
            blk.get("start") <= current_time <= blk.get("end")
        ...
        # =====================================================
        # 4. HARD RESET OLD SESSION FOR THIS CLASS
        # =====================================================
